...
-- CreateEnum
CREATE TYPE "MovementReason" AS ENUM ('PURCHASE', 'SALE', 'RETURN', 'MANUAL_ADJUST', 'DAMAGE', 'RESERVATION', 'RESERVATION_RELEASE');
...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CARD', 'PSE', 'NEQUI', 'DAVIPLATA', 'BANCOLOMBIA_TRANSFER', 'CASH_ON_DELIVERY', 'BANK_TRANSFER_MANUAL');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'AWAITING_VERIFICATION', 'APPROVED', 'DECLINED', 'VOIDED', 'ERROR', 'REFUNDED');
...
-- AddForeignKey
ALTER TABLE "ProductMedia" ADD CONSTRAINT "ProductMedia_optionValueId_fkey" FOREIGN KEY ("optionValueId") REFERENCES "ProductOptionValue"("id") ON DELETE SET NULL ON UPDATE CASCADE;
