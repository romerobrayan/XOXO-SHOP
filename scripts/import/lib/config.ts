// Shared configuration for the supplier import pipeline.
//
// The pipeline is a set of scripts run with tsx (CLAUDE.md: no REST layer —
// Server Actions are the app's interface; this is operator tooling). Both
// suppliers granted permission to use their photos and data; the User-Agent
// below is deliberately identifiable so they can see who is calling.
...
// override per product in seleccion.json.
